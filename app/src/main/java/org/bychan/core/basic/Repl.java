...
public class Repl<N> implements Runnable {
    ...
    public Repl( Language<N> language,  BufferedReader in,  BufferedWriter out, ParsingFunction<N> parsingFunction, EvaluationFunction<N> evaluationFunction) {
    ...
    private static <N> Method getEvaluateMethod( final N node) {
        try {
